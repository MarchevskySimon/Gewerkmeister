  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link" href="#soc_siete">SOCIAL NETWORKS</a>
    ...
    <header id="header" class="container-fluid text-center">
      ...
      <div class="header-text">
        ...
        <p>THERE IS NOTHING THAT WE CAN'T DO !</p>
      </div>
    </header>
    ...
    <main id="main" class="container-fluid">
      <div class="row">
        ...
        <div class="main_text col-lg-6 m-auto">
          <h6>WHO WE ARE</h6>
          <p>
            We are a developing company constantly creating new contacts with by
            foreign consumers. We deal with industrial electrical installation,
            residential electrical installation, photovoltaics and by installing
            network technologies.
            <br />
            We are constantly looking for new qualified employees who would
            bring us new experiences.
          </p>
