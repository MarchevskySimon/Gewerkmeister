  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            <a class="nav-link" href="#main">O NÁS</a>
            <a class="nav-link" href="#gallery">GALÉRIA</a>
            <a class="nav-link" href="#soc_siete">SOCIALNE SIETE</a>
    ...
    <header id="header" class="container-fluid text-center">
      ...
      <div class="header-text">
        ...
        <p>NIE JE NIČ ČO BY SME NEZVLÁDLI !</p>
      </div>
    </header>
    ...
    <main id="main" class="container-fluid">
      <div class="row">
        ...
        <div class="main_text col-lg-6 m-auto">
          <h6>KTO SME</h6>
          <p>
            Sme rozvíjajúca sa spoločnosť vytvárajúca si stále nové kontakty so
            zahranićnými spotrebiteľmi. Zaoberáme sa priemyselnou
            elektroinštaláciou, bytovou elektroinštaláciou, fotovoltaikou a
            inštaláciou sieťových technológií.
            <br />
            Neustále vyhľadávame nových kvalifikovaných spolupracovníkov ktorý
            by k nám priniesli nové skúsenosti.
          </p>
        </div>
      </div>
    </main>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 m-auto">
          <ul>
            ...
            <h6>VIZITKA</h6>
            <li>
              <a href="img/vizitka.jpg" target="_blank" download="vizitka.jpg"
                >Vizitka.jpg</a
              >
            </li>
          </ul>
